...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "sarthakchaudhary0203@gmail.com";
            ...
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                {leftLists.map((item, i) => (
                  <span
                    key={i}
                    className={`lg:py-4 lg:px-3 py-2 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E] ${i === 0 ? 'mt-20' : ''}`}
                  >
                    {item}
                  </span>
                ))}
              ...
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                ...
                {rightLists.map((item, i) => (
                  <span
                    key={i}
                    className="lg:py-4 lg:px-3 py-2 px-7 mx-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]"
                  >
                    {item}
                  </span>
                ))}
